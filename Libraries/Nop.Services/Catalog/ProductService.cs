...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        private readonly IRepository<DezineCorpSageandBranding> _dezineCorpSageandBrandingRepository;
        ...
        public ProductService(ICacheManager cacheManager,
            ...
            IRepository<DezineCorpSageandBranding> dezineCorpSageandBrandingRepository,
            ...
            IStoreMappingService storeMappingService)
        {
            ...
            this._dezineCorpSageandBrandingRepository = dezineCorpSageandBrandingRepository;
        ...
        public DezineCorpSageandBranding GetDezineCorpSageandBranding(int productId)
        {
            if (productId == 0)
                return null;

            return _dezineCorpSageandBrandingRepository.Table.FirstOrDefault(x => x.ProductId == productId);
        }
